...
public class MainLobbyView : BaseView
{
    ...
    public GameItemData[] gameNames = new GameItemData[] { new GameItemData(GameEnum.a,"西游记",""),new GameItemData(GameEnum.b,"斗破苍穹",""),new GameItemData(GameEnum.c,"战狼",""),new GameItemData(GameEnum.d,"天龙八部",""),new GameItemData(GameEnum.e,"金瓶梅",""), new GameItemData(GameEnum.f,"屠龙宝刀",""), new GameItemData(GameEnum.g,"深海捕鱼",""),new GameItemData(GameEnum.h,"丧尸围城","") };
